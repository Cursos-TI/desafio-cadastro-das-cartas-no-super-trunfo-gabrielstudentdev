...
int main() {
    ...
    int populacao1, populacao2, pontoturisticos1, pontosturisticos2, resultadoA, resultadoB, resultadoC, resultadoD, resultadoE, resultadoF;
    ...
    resultadoD = pontoturisticos1 > pontosturisticos2;
