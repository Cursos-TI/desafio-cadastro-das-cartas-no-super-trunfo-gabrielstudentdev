...
int main() {
    // Classe variaveis para a primeira e segunda carta
    ...
    float area1, pib1, area2, pib2, densiadepopulacional1, densidadepopulacional2, pibpercapita1, pibpercapita2;
    ...
    // Operação Divisão para gerar o pibpercapita
